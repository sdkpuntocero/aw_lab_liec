...
{
    public partial class panel_capt : System.Web.UI.Page
    {
        public static int int_clte, int_clte_obras, int_pnlID, int_rppc;
        ...
        protected void chkb_28_rppc_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                dt_fcol = DateTime.Parse(fcol_rppc.Text);
                lbl_28_rppc.Text = dt_fcol.AddDays(28).ToShortDateString();
            }
        }
        ...
        protected void btn_guardar_rppc_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int int_tesp_rppc, int_tcont_rrp, int_sit_rppc, presi_rppc;
